...
# 基本參數
KAFKA_BROKER_URL = '52.15.137.0:9092'  # 設定要連接的Kafka群
WORKSHOP_ID = 'eb103test'  # 修改成你/妳的班級編號
STUDENT_ID = '21'  # 修改成你/妳的名稱
...
if __name__ == '__main__':
    ...
    try:
        ...
        producer.produce(topicName, '3', STUDENT_ID + '|08')  # 第 8題
        producer.produce(topicName, '2', STUDENT_ID + '|09')  # 第 9題
        ...
        producer.produce(topicName, '5', STUDENT_ID + '|22')  # 第22題
